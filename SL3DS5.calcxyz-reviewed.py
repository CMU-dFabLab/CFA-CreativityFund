...
def camxyzparam(pxpy):
    ...
    phir, phil = 0, 0     #rotation angle around X axis of both cameras
    x0r, x0l = -250, 250     #translation in X direction of both cameras
    y0r, y0l = 0, 0      #translation in Y direction of both cameras
    z0r, z0l = 0, 0      #translation in Z direction of both cameras
    ccddr, ccddl = 3.67, 3.67    #focal lenght of both cameras in mm
    ###################################################
    x0, y0, z0 = x0r, y0r, z0r 
    x1, y1, z1 = -(pxpy[0]-960)*fcr, (pxpy[1]-540)*fcr, ccddr   #px1 and py1 and pz1
    alfa, beta = tetr, phir 
    gama = 0  
    ...
    xh3, yh3, zh3 = -(pxpy[2]-960)*fcl, (pxpy[3]-540)*fcl, ccddl  #px2 and py2 and pz2
    alfa, beta = tetl, phil 
    gama = 0  
